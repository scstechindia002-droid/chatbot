      ...
      function getReply(userMessage) {
        ...
        replyMessageContainer.innerHTML = `<div>Hello! Welcome to SCS Tech India. How may I help you?<div class="sm-screen-flex"><button  class="border-0 rounded-1" onclick="aboutBtn()">About Us </button> <button class="border-0 rounded-1" onclick="serviceTab()">Services </button> <button  class="border-0 rounded-1">Industries</button> <button  class="border-0 rounded-1">About Us </button> <button  class="border-0 rounded-1">Careers</button></div></div>`;
